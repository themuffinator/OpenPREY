...
public:
	...
	virtual void	SetTargetEntity( idEntity *ent, int traceId=0, const idVec3 &offset=vec3_origin );
	virtual void	SetTargetEntity( idEntity *ent, const char *boneName, const idVec3 &offset=vec3_origin );
