...
// This is the Prey beam renderer that consumes hhDeclBeam node data.

static const struct viewDef_s *current_view;
...
idRenderModel *hhRenderModelBeam::InstantiateDynamicModel( const struct renderEntity_s *renderEntity, const struct viewDef_s *view, idRenderModel *cachedModel ) {
	...
	if ( cachedModel != NULL ) {
		...
		for ( int i = 0; i < declBeam->numBeams; i++ ) {
			const int vertNum = declBeam->numNodes - 1;
			...
			for ( int m = 0; m < vertNum; m++ ) {
				...
				tri->verts[4 * m + 0].color[0] = 255;
				tri->verts[4 * m + 0].color[1] = 255;
				tri->verts[4 * m + 0].color[2] = 255;
				tri->verts[4 * m + 0].color[3] = 255;

				tri->verts[4 * m + 1].Clear();
				tri->verts[4 * m + 1].st[0] = 0;
				tri->verts[4 * m + 1].st[1] = 1;
				tri->verts[4 * m + 1].color[0] = 255;
				tri->verts[4 * m + 1].color[1] = 255;
				tri->verts[4 * m + 1].color[2] = 255;
				tri->verts[4 * m + 1].color[3] = 255;

				tri->verts[4 * m + 2].Clear();
				tri->verts[4 * m + 2].st[0] = 1;
				tri->verts[4 * m + 2].st[1] = 0;
				tri->verts[4 * m + 2].color[0] = 255;
				tri->verts[4 * m + 2].color[1] = 255;
				tri->verts[4 * m + 2].color[2] = 255;
				tri->verts[4 * m + 2].color[3] = 255;

				tri->verts[4 * m + 3].Clear();
				tri->verts[4 * m + 3].st[0] = 1;
				tri->verts[4 * m + 3].st[1] = 1;
				tri->verts[4 * m + 3].color[0] = 255;
				tri->verts[4 * m + 3].color[1] = 255;
				tri->verts[4 * m + 3].color[2] = 255;
				tri->verts[4 * m + 3].color[3] = 255;
		...
		for ( int i = 0; i < declBeam->numBeams; i++ ) {
			for ( int m = 0; m < 2; m++ ) {
				...
				tri->verts[0].st[0] = 0;
				tri->verts[0].st[1] = 0;
				tri->verts[0].color[0] = 255;
				tri->verts[0].color[1] = 255;
				tri->verts[0].color[2] = 255;
				tri->verts[0].color[3] = 255;

				tri->verts[1].Clear();
				tri->verts[1].st[0] = 0;
				tri->verts[1].st[1] = 1;
				tri->verts[1].color[0] = 255;
				tri->verts[1].color[1] = 255;
				tri->verts[1].color[2] = 255;
				tri->verts[1].color[3] = 255;

				tri->verts[2].Clear();
				tri->verts[2].st[0] = 1;
				tri->verts[2].st[1] = 0;
				tri->verts[2].color[0] = 255;
				tri->verts[2].color[1] = 255;
				tri->verts[2].color[2] = 255;
				tri->verts[2].color[3] = 255;

				tri->verts[3].Clear();
				tri->verts[3].st[0] = 1;
				tri->verts[3].st[1] = 1;
				tri->verts[3].color[0] = 255;
				tri->verts[3].color[1] = 255;
				tri->verts[3].color[2] = 255;
				tri->verts[3].color[3] = 255;
...
void hhRenderModelBeam::UpdateSurface( const struct renderEntity_s *renderEntity, const int index, const hhBeamNodes_t *beam, modelSurface_t *surf ) {
	...
	const int numLines = declBeam->numNodes - 1;
