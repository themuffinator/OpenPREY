...
extern idCVar r_shaderLevel;			// material shader quality level for shaderLevel*/shaderFallback* stage gates
...
extern idCVar r_usePortalViewBlocks;		// 1 = honor game-controlled portal view blocking
