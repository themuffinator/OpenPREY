...
def validate_commit_workflow() -> None:
    ...
    require(source, ".tmp/validation/linux-sanitizer-builddir/.tmp/openprey_gamelibs_stage/openprey_gamelibs_stage_manifest.json", "commit validation sanitizer staging manifest")
